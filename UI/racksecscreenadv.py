...
class Ui_DialogSCSC(object):
    def setupUi(self, Dialog):
        ...
        for bn in range(0, 11):
            self.Beam[bn] = QtWidgets.QLabel(Dialog)
            self.Beam[bn].setGeometry(QtCore.QRect(50, 350, 296, 56))
        ...
        self.lineEditHB = ['', '', '', '', '', '', '', '', '', '', '', '']
        for bn in range(0, 11):
            self.lineEditHB[bn] = QtWidgets.QLineEdit(Dialog)
            self.lineEditHB[bn].setGeometry(QtCore.QRect(270, 345, 50, 20))
            font = QtGui.QFont()
            font.setFamily("Arial")
            font.setPointSize(12)
            self.lineEditHB[bn].setFont(font)
